...
const empresaXYZ = new Empresa("XYZ Ltda.");

empresaXYZ.agregarEmpleado(Empleado1);
empresaXYZ.agregarEmpleado(Empleado2);

empresaXYZ.calcularTotalSalarios();

empresaXYZ.eliminarEmpleado("Carlos García");
